...
[Возможности](#возможности) | [Скриншоты](#скриншоты) | [Автоматизация](#автоматизация) | [AI Инсайты](#ai-инсайты) | [ABRP](#abrp--live-телеметрия) | [Установка](#установка) | [Сборка](#сборка-из-исходников) | [Релизы](https://github.com/AndyShaman/BYDMate/releases) | [Поддержать](SUPPORT.md)
